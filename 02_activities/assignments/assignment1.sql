...
The logical data model is on the 02_activities\assignments\images\customer_purchases.jpg path
...
select * from vendor v INNER JOIN vendor_booth_assignments a ON (v.vendor_id = a.vendor_id)
...
FROM customer c INNER JOIN customer_purchases p on (c.customer_id= p.customer_id)
...
INSERT INTO new_vendor values (10, 'Abrahim Bareky','Foods','Abrahim','Senra Abrahao')
